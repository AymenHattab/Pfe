    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider<clientbloc>(
            create: (context) => clientbloc(clientloadedevent())),
        BlocProvider<Produitbloc>(
            create: (context) => Produitbloc(Produitloadingevent())),
        BlocProvider<verificationbloc>(create: (context) => verificationbloc()),
        BlocProvider<BasketBloc>(create: (context) => BasketBloc()),
        BlocProvider<BaskecontenttBloc>(create: (context) => BaskecontenttBloc()),
      ],
      child: MaterialApp(
